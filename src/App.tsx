      ...
      projetos: {
        ...
        lista: [
          ...
          },
          {
            ...
            descricao: "Duelo de Honra é um jogo de luta desenvolvido em C# e Unity focado em controles dinâmicos e partidas ágeis.",
            tags: ["C#", "Unity"],
        ...
        <section id="sobre" className="section-wrapper" aria-labelledby="titulo-sobre">
          <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 0.9fr', gap: '4rem', alignItems: 'start' }}>
            ...
            <aside style={{
              ...
              <h3 id="titulo-habilidades" style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '2rem' }}>{conteudos[idioma].sobre.habTitulo}</h3>
