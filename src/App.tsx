  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'dark-theme' : 'light-theme'}`}>
      ...
      <header className="navbar">
        <a href="#inicio" className="text-xl font-bold tracking-tight" aria-label="Gabriel - Ir para o início">
          Gabriel
        </a>

        {/* Identificação de navegação para o leitor de tela */}
        <nav aria-label="Navegação Principal">
          ...
          <a 
            ...
            aria-label="Acessar perfil de Gabriel no GitHub (abre em nova aba)"
          >
            <svg width="16" height="16" className="fill-current" viewBox="0 0 24 24" aria-hidden="true">
          ...
          {/* Botão com estado interativo e rótulo explicativo */}
          <button 
      ...
      <main>
        ...
        <section id="inicio" className="hero-section" aria-label="Apresentação inicial">
          <div className="hero-content">
            <div className="badge-available">
              ...
              <span>Disponível para trabalhar</span>
            </div>
            <h1>
              Olá, eu sou <br />
              <span>Gabriel</span>
            ...
            <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
              ...
              <a 
                ...
                aria-label="Baixar o arquivo do currículo de Gabriel em PDF"
              >
                <svg 
                  width="16" 
                  height="16" 
          ...
          <div className="profile-container">
            <div className="profile-image-wrapper">
              {/* Alt informativo descrevendo o sujeito */}
              <img src={minhaFoto} alt="Foto de perfil do desenvolvedor ao ar livre, usando óculos de sol e regata esportiva." />
            </div>
        ...
        <section id="sobre" className="section-wrapper" aria-labelledby="titulo-sobre">
          <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 0.9fr', gap: '4rem', alignItems: 'start' }}>
            ...
            <div>
              ...
              <h2 id="titulo-sobre" className="section-title" style={{ fontSize: '3rem', marginBottom: '2rem' }}>Quem Eu Sou?</h2>
              ...
              <ul style={{ 
                ...
                <li style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', fontSize: '0.95rem', opacity: 0.9 }}>
                  ...
                  Formação: Bacharelado em Ciência da Computação — Concluído
                </li>
              </ul>

              {/* Subseção Interesses (Formatado em Lista) */}
              <div>
                <h3 style={{ fontSize: '1rem', fontWeight: 700, marginBottom: '1rem' }}>Interesses</h3>
            ...
            <aside style={{
              ...
              <h3 id="titulo-habilidades" style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '2rem' }}>Habilidades & Ferramentas</h3>
                ...
                {Object.entries(habilidades).map(([categoria, itens]) => {
                  ...
                  return (
                    <div key={categoria}>
                      ...
                      <ul style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', listStyle: 'none', paddingLeft: 0 }}>
                        {itens.map(item => (
                          <li key={item}>
                            <span style={estiloTag}>
                              {item}
                            </span>
                          </li>
                        ))}
        ...
        <section id="projetos" className="section-wrapper" aria-labelledby="titulo-projetos">
          ...
          <h2 id="titulo-projetos" className="section-title">Meus Projetos Recentes</h2>
        ...
        <section id="curriculo" className="section-wrapper" style={{ paddingBottom: '5rem' }} aria-labelledby="titulo-curriculo">
          ...
          <h2 id="titulo-curriculo" className="section-title" style={{ marginBottom: '1.5rem' }}>Minhas Qualificações</h2>
          ...
          <div style={{
            ...
            <div style={{ 
              ...
              <a 
                ...
                aria-label="Baixar o PDF do Currículo de Gabriel Galvão"
              >
                <svg 
                  width="14" 
                  height="14" 
            ...
            <div style={{ 
              ...
              <iframe
                ...
                title="Visualizador de PDF - Currículo de Gabriel Galvão"
                width="100%"
                height="100%"
                style={{ border: 'none' }}
              />
      ...
      <footer className="footer">
        <p>© 2026 Gabriel. Portfólio Ajustado com Acessibilidade.</p>
      </footer>
    </div>
  );
};
